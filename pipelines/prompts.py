...
4.  **Разделение для звукорежиссера (КРИТИЧНО):**
    -   Если внутри одного абзаца повествования (`narration`) происходит явное звуковое событие (стук в дверь, крик на фоне) или смена сцены, **ОБЯЗАТЕЛЬНО раздели этот абзац на два или более блока `narration`**. Событие должно оказаться в начале нового блока.
...
!!! ВАЖНОЕ ПРАВИЛО РАЗДЕЛЕНИЯ И КОНТЕКСТА !!!
...
2. ЕСЛИ speaker — Имя Персонажа:
   ...
   - ОБРАТИ ВНИМАНИЕ: Если текст выделен звездочками (например, `*он так бесит*`), это внутренние мысли персонажа. Обязательно подбирай соответствующую эмоцию для мыслей (например, 'whisper', 'calm' или 'internal_monologue').
